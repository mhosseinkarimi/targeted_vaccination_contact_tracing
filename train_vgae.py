...
plt.title("Reconstruction Loss for VGAE", fontdict=font_title)
plt.xlabel("Epoch", fontdict=font)
plt.ylabel("Loss Value", fontdict=font)
plt.grid("minor")
plt.savefig("/home/hossein/Projects/Covid Contact Tracing/artifacts/figures/vgae/loss.png")


fig_auc = plt.figure(figsize=(15, 8))
plt.plot(np.arange(1, epochs+1), auc_list, "b--o", label="AUC")
plt.title("Area Under Curve for VGAE", fontdict=font_title)
plt.xlabel("Epoch", fontdict=font)
plt.ylabel("Score", fontdict=font)
plt.grid("minor")
plt.savefig("/home/hossein/Projects/Covid Contact Tracing/artifacts/figures/vgae/auc_score.png")

fig_ap = plt.figure(figsize=(15, 8))
plt.plot(np.arange(1, epochs+1), ap_list, "r--o", label="Accuracy")
plt.title("Accuracy of Reconstruction for VGAE", fontdict=font_title)
plt.xlabel("Epoch", fontdict=font)
plt.ylabel("Score", fontdict=font)
plt.grid("minor")
plt.savefig("/home/hossein/Projects/Covid Contact Tracing/artifacts/figures/vgae/ap_score.png")

# save model
torch.save(model.state_dict(), 'artifacts/models/vgae/gcn_vgae.pt')
print("Model was saved in: artifacts/models/vgae/gcn_vgae.pt")